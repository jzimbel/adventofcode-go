...
import (
	...
	"github.com/jzimbel/adventofcode-go/solutions/y2019/d12"
	"github.com/jzimbel/adventofcode-go/solutions/y2019/d13"
)
...
func init() {
	...
	r.Register(y, 12, d12.Solve)
	r.Register(y, 13, d13.Solve)
}
